...
#this profile be changed read from config file in system#
HUOBI_PARAMS={
    'ACCESS_KEY':'',
    'SECRET_KEY':'',
    'ACCOUNT_ID':'',
    'URL':'https://api.huobi.br.com',
    'ETH_ADDRESS':''
}

HUOBI_API = {
    'ACCOUNTS':'/v1/account/accounts',
    'BALANCE':'/v1/account/accounts/{0}/balance',
    'SEND_ORDER':'/v1/order/orders/place',
    'CANCEL_ORDER':'/v1/order/orders/{0}/submitcancel',
    'ORDER_INFO':'/v1/order/orders/{0}',
    'ORDER_RESULT':'/v1/order/orders/{0}/matchresults',
    'ORDER_LIST':'/v1/order/orders',
    'ORDER_BATCH_LIST':'/v1/order/matchresults',
    'WITHDRAW':'/v1/dw/withdraw/api/create',
    'CANCEL_WITHDRAW':'/v1/dw/withdraw-virtual/{0}/cancel'
}
